...
func TestNewInstallationFilterHandler(t *testing.T) {
	...
	filter := NewInstallationFilterHandler(mockHandler, registry, nil, metricsRegistry, nil, nil)
...
func TestInstallationFilterHandler_Handles(t *testing.T) {
	...
	filter := NewInstallationFilterHandler(mockHandler, registry, nil, nil, nil, nil)
...
func TestInstallationFilterHandler_RepositoryFallback_Success(t *testing.T) {
	...
	filter := NewInstallationFilterHandler(mockHandler, registry, mockService, nil, nil, nil)
...
func TestLookupMethodMetrics_RepoCacheHit(t *testing.T) {
	...
	filter := NewInstallationFilterHandler(mockHandler, registry, nil, metricsRegistry, repoCache, orgCache)
...
func TestLookupMethodMetrics_RepoAPILookup(t *testing.T) {
	...
	filter := NewInstallationFilterHandler(mockHandler, registry, mockService, metricsRegistry, nil, nil)
...
func TestMetricsRegistration(t *testing.T) {
	...
	_ = NewInstallationFilterHandler(mockHandler, registry, nil, metricsRegistry, nil, nil)

...
// 	)
// 	workflowARule := rp.AddRule(
// 		ExactPathMatcher("/repos/testorg/testrepo/actions/workflows/101"),
// 		"testdata/responses/workflow_101.yml",
// 	)
// 	workflowBRule := rp.AddRule(
// 		ExactPathMatcher("/repos/testorg/testrepo/actions/workflows/102"),
// 		"testdata/responses/workflow_102.yml",
// 	)
// 	workflowCRule := rp.AddRule(
// 		ExactPathMatcher("/repos/testorg/testrepo/actions/workflows/103"),
// 		"testdata/responses/workflow_103.yml",
// 	)
// 	workflowDRule := rp.AddRule(
// 		ExactPathMatcher("/repos/testorg/testrepo/actions/workflows/104"),
// 		"testdata/responses/workflow_104.yml",
// 	)
...
// 	assert.Equal(t, 1, workflowARule.Count, "incorrect workflow fetch count for 101")
// 	assert.Equal(t, 1, workflowBRule.Count, "incorrect workflow fetch count for 102")
// 	assert.Equal(t, 1, workflowCRule.Count, "incorrect workflow fetch count for 103")
// 	assert.Equal(t, 0, workflowDRule.Count, "incorrect workflow fetch count for 104")
// }
...
// 	created := time.Date(2020, 9, 30, 17, 42, 10, 0, time.UTC)
